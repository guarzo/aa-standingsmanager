...
urlpatterns = [
    ...
    path("api/approve-request/<int:request_pk>/", views.api_approve_request, name="api_approve_request"),
    path("api/reject-request/<int:request_pk>/", views.api_reject_request, name="api_reject_request"),
    path("api/approve-revocation/<int:revocation_pk>/", views.api_approve_revocation, name="api_approve_revocation"),
    path("api/reject-revocation/<int:revocation_pk>/", views.api_reject_revocation, name="api_reject_revocation"),
