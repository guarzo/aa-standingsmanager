...
from standingsmanager import tasks
from standingsmanager.models import SyncManager
...
MANAGERS_PATH = "standingsmanager.managers"
MODELS_PATH = "standingsmanager.models"
TASKS_PATH = "standingsmanager.tasks"
