...
- The sync logic has improved:
  - Replacing contacts will no longer delete all and then recreate contacts. Instead individual contacts are added, deleted and updated as needed.
...
- Setting of alliance character now also triggers sync of all wars
