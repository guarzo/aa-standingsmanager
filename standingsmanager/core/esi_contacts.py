...
# Old app_settings imports removed - these settings are deprecated
# War targets and alliance contacts functionality removed in refactored version
...
class EsiContactsContainer:
    ...
    def get_label_by_name(self, name: str) -> Optional[EsiContactLabel]:
        ...
        Returns:
            EsiContactLabel if found, None otherwise
        """
    ...
    def filter_by_label(self, label_name: str) -> Set[EsiContact]:
        """Get all contacts with a specific label.

        Args:
            label_name: Name of the label to filter by

        Returns:
            Set of contacts that have the specified label
        """
